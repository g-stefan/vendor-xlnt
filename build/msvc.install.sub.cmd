...
xcopy /Y /S /E "temp\xlnt\bin\*.exe" "%INSTALL_PATH_BIN%\"
xcopy /Y /S /E "temp\xlnt\bin\*.dll" "%INSTALL_PATH_BIN%\"
...
xcopy /Y /S /E "temp\xlnt\bin\*.exe" "%INSTALL_PATH_DEV%\bin\"
xcopy /Y /S /E "temp\xlnt\bin\*.dll" "%INSTALL_PATH_DEV%\bin\"
xcopy /Y /S /E "temp\xlnt\include\" "%INSTALL_PATH_DEV%\include\"
copy /Y /B "temp\xlnt\lib\*.lib" "%INSTALL_PATH_DEV%\lib\*"
